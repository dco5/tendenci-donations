...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Donation.status'
        db.alter_column(u'donations_donation', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Donation.status'
        db.alter_column(u'donations_donation', 'status', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'donations.donation': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'donation_creator'", 'null': 'True', 'to': u"orm['auth.User']"}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'donation_owner'", 'null': 'True', 'to': u"orm['auth.User']"}),
